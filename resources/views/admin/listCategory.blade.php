...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <span class="input-group-btn">
            <button type="submit" class="btn btn-purple btn-sm" id="search_category">
                        ...
                        <div class="col-xs-12">
                            <table id="cate-table" class="table  table-bordered table-hover">
                                ...
                                <tbody id="body_list_category">
                                    ...
                                    <tr row_id_category="<?php echo $cate->id; ?>">
            ...
            <!-- <form method="get" id="form-cate"> -->
                ...
                <!-- Modal content-->
                    ...
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" style="text-align: center;"><b>Add Category</b></h3>
                    </div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group" >
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style="margin-top: 22px;"><b>Type:</b></label>
...
<div class="modal fade" id="editModal-category" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h3 class="modal-title"><b>Edit Category</b></h3>
                    </div>
                    <div class="modal-body">
                        <span id="form_output"></span>
                        <div class="row">
...
<div class="modal fade" id="deleteModal-category" role="dialog">
            <div class="modal-dialog">
                ...
                <!-- Modal content-->
                        ...
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h3 style="text-align: center;" class="modal-title"><b>Confirm</b></h3>
                        </div>
                        <div class="modal-body">
